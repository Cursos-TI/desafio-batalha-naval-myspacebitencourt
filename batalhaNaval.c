...
#include <stdio.h>
//Definindo constantes, assim o codigo fica mais legível e facil de modificar
#define LINHAS 10
#define COLUNAS 10
#define NAVIO 3
#define AGUA 0
...
// A variável 'k' foi usada para indicar o avanço simultâneo da linha e da coluna (diagonal)
// já que 'i' e 'j' são usados para linha e coluna separadamente.
...
// 6. Função para posicionar um navio na diagonal secundária (linha cresce e coluna decresce)
...
// Também utilizamos 'k' pois representa o avanço na linha e recuo na coluna simultaneamente.
...
int main() {
    ...
    printf("Posicões dos navios:\n\n" );
    printf("A água é representada por '0' e os navios por '3'.\n\n");
